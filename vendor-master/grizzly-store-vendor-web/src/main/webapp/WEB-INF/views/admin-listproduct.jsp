...
<form>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            <center><span style="color:black;font-weight:bold">Price/Product</span>
                                                        </td>
                                                      
                                                            <td>
                                                            <center><span style="color:black;font-weight:bold">In Stock</span>
                                                        </td>
                                                        <td>
                                                            <center><span style="color:black;font-weight:bold">Requirements</span>
                                                        </td>
                                                         <td>
                                                            <center><span style="color:black;font-weight:bold">Rating</span>
                                                        </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span style="color: gray">${product.inStock}
                            </span>
                          </td>
                          <td>
                            <span style="color: gray">${product.requirement}
                            </span>
                          </td>
                          <td>
                            <span style="color: gray">${product.rating}
                           ...
                           <td>
                            <center>
                              <a href="" class="btn btn-secondary form-rounded"> &nbsp;Manage&nbsp; 
                              </a>&emsp;&emsp;</center>
                       </tr>
                       </c:forEach>                       
                                        </table>
